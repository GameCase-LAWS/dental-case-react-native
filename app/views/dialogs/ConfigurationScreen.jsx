...
export const ConfigurationScreen = (props) => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: '#fff', position: 'relative', paddingHorizontal: 90, paddingVertical: 15 }]}>
      <TouchableOpacity activeOpacity={0.9} style={{ position: 'absolute', right: 15, top: 15 }}>
        <CloseIcon color={appColors.primary} height={30} width={30} />
      </TouchableOpacity>

      <Typography paragraph variant="header34" style={{ textAlign: 'center' }}>Configurações</Typography>
      <View>
        {/* Sons */}
