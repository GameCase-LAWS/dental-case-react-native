...
export const CreditsScreen = ({ navigation, ...props }) => {
  ...
  return (
    <ImageBackground source={BlueBackgroundImage} style={theme.styles.flex} resizeMode="stretch">
      <Container containerStyle={{ marginLeft: 'auto', marginRight: 'auto' }} style={{ paddingVertical: theme.measure(1), justifyContent: 'space-between' }}>
        ...
        <Image source={CreditsImage} resizeMode='contain' style={{ height: theme.measure(3.2) }} />

        <CircleButton size={theme.measure(3)} style={{ position: 'absolute', bottom: theme.measure(2), right: 0 }} onPress={handleBack}>
          <BackIcon color='#000' width={theme.measure(1.5)} height={theme.measure(1.5)} />
        </CircleButton>
      </Container>
    </ImageBackground>
  );
