...
const teethPaths = [
  ...
  {
    d:
      "M453 228C453 352.264 352.264 453 228 453C103.736 453 3 352.264 3 228C3 103.736 103.736 3 228 3C352.264 3 453 103.736 453 228Z",
  ...
  {
    d:
      "M433 218C433 336.741 336.741 433 218 433C99.2588 433 3 336.741 3 218C3 99.2588 99.2588 3 218 3C336.741 3 433 99.2588 433 218Z",
      ...
      >
        ...
        >
          ...
          <Animated.View style={{ opacity: moveAnim, height: labelHeight }}>
            <Image
              ...
              style={{
                resizeMode: "contain",
                width: theme.measure(38),
                height: theme.measure(8),
              }}
            />
            <Typography
              variant='header34'
        ...
        <Animated.View
          style={{
            ...
            right: 0,
            alignItems: "center",
            paddingVertical: theme.measure(0.5),
            bottom: theme.measure(4),
          }}
        >
