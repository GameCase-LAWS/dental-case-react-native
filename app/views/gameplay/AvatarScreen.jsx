...
export const AvatarScreen = ({ route, navigation, ...props }) => {
  ...
  return (
    <Container style={{ paddingHorizontal: theme.measure(4), paddingVertical: theme.measure(3) }} containerStyle={{ backgroundColor: appColors.backgroundBlue }}>
              ...
              .map((c, i) =>
                <Grid item size={4} key={i}>
                  <TouchableOpacity onPress={handleAvatarSelect(c)} activeOpacity={0.9}>
                    <Image source={c} style={theme.styles.avatar} resizeMode="contain" />
                  </TouchableOpacity>
