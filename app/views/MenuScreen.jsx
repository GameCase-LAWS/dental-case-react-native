...
export const MenuScreen = ({ navigation, ...props }) => {
  ...
  return (
    <Container
      style={{ paddingHorizontal: meansure(4), paddingVertical: meansure(3) }}
    ...
    >
      ...
      <View style={styles.spacedRow}>
        ...
        <Button label="Histórico" buttonStyle={{ width: meansure(9), height: meansure(4) }} onPress={() => console.log(3)} />
      </View>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'flex-end' }}>
        <CircleButton
          size={meansure(3)}
          style={{ marginRight: meansure(1) }}
          label='Créditos'
          containerStyle={styles.circlePadding}
          onPress={() => navigation.navigate('Credits')}
        >
          <CreditsIcon height={meansure(1.5)} width={meansure(1.5)} />
        </CircleButton>
        <CircleButton
          size={meansure(3)}
          style={{ marginRight: meansure(1) }}
        ...
        >
          <Image source={CogSource} style={{ width: meansure(1.5), height: meansure(1.5) }} />
        </CircleButton>
        <CircleButton
          size={meansure(3)}
          label='Desconectar'
        ...
        >
          <Image source={LogoutSource} style={{ width: meansure(1.5), height: meansure(1.5) }} />
        </CircleButton>
      </View>
    </Container>
  );
